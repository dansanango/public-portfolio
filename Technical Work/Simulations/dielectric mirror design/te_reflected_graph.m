...
for i = 1:samples
    ...
    V_hi = propagation_matrix(Z_h_TE, Z_i_TE, kz_h, d_h, 0);
    V_lh = propagation_matrix(Z_l_TE, Z_h_TE, kz_l, d_l, 0);
    V_hl = propagation_matrix(Z_h_TE, Z_l_TE, kz_h, d_h, 0);
    V_sh = propagation_matrix(Z_s_TE, Z_h_TE, kz_s, 0, d_h);
...
title('Power Reflected vs. Wavelength (TE) (N = 20)');
...
title('Reflection Phase vs. Wavelength (TE) (N = 20)');
xlabel('Wavelength (nm)');
